    ...
    <View>
      <AppText variant="small" color="ink3" style={{ marginBottom: 10 }}>
        {(transcriptMixedProvenance
          ...
          ? 'The transcript of this session, kept on this device. The audio was sent to the cloud (Groq) to transcribe; only this text is stored with the note — the recording card in the rail shows whether a copy of the audio is still held on this device. There is no on-device de-identification hop in demo mode.'
          : transcriptFromCloud === false && audioLeftDevice === true
            ? 'This text was entered by the clinician, not produced by transcription. The audio was sent to the cloud (Groq) to transcribe, but no transcript came back. The recording is not stored with the note, so this typed text is the only saved record of the session.' +
              (draftedInCloud === true
  ...
  return (
    <Card tone="elevated" elevation="none" radius="md" style={{ backgroundColor: bg, borderColor: bg }}>
      ...
      <AppText variant="small" color="ink2" style={{ marginTop: 8, lineHeight: 18 }}>
        ...
        {kept
          ? audioWentToCloud
            ? 'You chose to keep this recording. A copy was sent to the cloud (Groq) to transcribe; the copy you kept stays on this device, lasts only as long as this browser tab, and makes replay-with-notes possible for this session.'
          ...
          : held
            ? audioWentToCloud
              ? 'A copy of this recording was sent to the cloud (Groq) to transcribe. The recording itself is still held in this browser tab while you review — it is deleted when you sign this note, unless you keep it.'
            ...
            : disposition === 'discarded'
              ? audioWentToCloud
                ? 'This recording was sent to the cloud (Groq) to transcribe. The copy held on this device has been deleted — deletion is the default at sign-off. Only the draft you reviewed remains.'
              ...
              : audioWentToCloud
                ? 'A recording was sent to the cloud (Groq) to transcribe. No copy of it is held on this device now. Only the draft you reviewed remains.'
